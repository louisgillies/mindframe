...
- Run **Animal Magic → Rabbit mode** to generate 10 ideas, then bring the best 3 to the dinner table for debate
- Run **Animal Magic → Eagle mode** for a strategic overview, then have the dinner guests stress-test it
- Run **Animal Magic → Dolphin mode** for creative solutions, then have the skeptics (Feynman, Hume, Descartes) tear them apart
...
- "Add Sun Tzu and Machiavelli to debate my go-to-market strategy"
- "Full dinner on the future of education — use the Scottish Enlightenment table"
- "Quick round: what would the table think about universal basic income?"
